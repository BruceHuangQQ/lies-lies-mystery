...
/** Column centers ~22% / 50% / 78% — a bit more space between suspects than tighter clusters. */

// layout here is annoying; keep AI as is
          ...
          <Dialog>
            ...
            <DialogContent>
              ...
              {/* <section className="mt-4 border-t border-border pt-4">
                <p className="retro mb-2 text-[9px] font-bold tracking-wide text-muted-foreground uppercase">
                  {caseContent.instructionBadge}
                </p>
                <p className="retro text-muted-foreground text-[10px] leading-relaxed">
                  {caseContent.howToPlay}
                </p>
              </section> */}
              <DialogClose asChild>
